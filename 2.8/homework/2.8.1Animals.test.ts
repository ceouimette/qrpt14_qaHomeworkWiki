 ...
 */
 ...
 class Fish {
        ...
        food: string;
        saltwater: string;
        constructor(name:string, food:string, saltwater:string){
        this.name= name;
        this.food= food;
        this.saltwater= saltwater
        }
        soundOff(): string {
            return `The ${this.name} makes the sound.`;
         } 
         habitat(): string {
            return `${this.name} is a ${this.saltwater} fish`;
         }        
 };
 /**
...
class Bird {
   ...
   soundOff(): string {
    ...
    fly(): string {
      return `The ${this.name} flies at speeds of up to ${this.flightSpeed} meters per second!`; //"The swallow flies at speeds of up to 11 meters per second!"
    }
};
 ...
 describe("Testing animals", () => {
    ...
    describe("Fish", () => {
       ...
       let goldfish = new Fish("goldfish", "pellets", "fresh water");
       let shark = new Fish("shark", "fish", "saltwater");
       it("are animals", () => {
